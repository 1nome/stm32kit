...
void I2C1_write(const uint8_t data){
...
void I2C1_send_addr(const uint8_t addr){
	I2C1->DR = addr;
	//io_set(LED_IN_1, 1);	// status
...
void I2C1_setup(){
	...
	pin_setup_af(I2C1_SCL, PIN_MODE_AF, PIN_PULL_UP, PIN_SPEED_LOW, PIN_TYPE_OPENDRAIN, PIN_AF4);
	pin_setup_af(I2C1_SDA, PIN_MODE_AF, PIN_PULL_UP, PIN_SPEED_LOW, PIN_TYPE_OPENDRAIN, PIN_AF4);
